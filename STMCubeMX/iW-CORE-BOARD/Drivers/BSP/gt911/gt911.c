...
//  }
	...
	uint32_t cycles_per_ms = HAL_RCC_GetSysClockFreq() / 1000; // Frequência de clock / 1000
	uint32_t nop_count = cycles_per_ms / 5; // Aproximando que cada NOP consome 5 ciclos de clock no Cortex-M7
