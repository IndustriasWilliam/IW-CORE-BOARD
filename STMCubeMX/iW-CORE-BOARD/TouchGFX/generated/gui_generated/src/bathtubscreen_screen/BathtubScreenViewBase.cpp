    ...
    buttonCallback(this, &BathtubScreenViewBase::buttonCallbackHandler)
{
    ...
    circleLight1Painter.setColor(touchgfx::Color::getColorFromRGB(204, 70, 70));
    ...
    circleLight2Painter.setColor(touchgfx::Color::getColorFromRGB(204, 70, 70));
    ...
    circleLight3Painter.setColor(touchgfx::Color::getColorFromRGB(204, 70, 70));
    ...
    scrollWheelTemperature.setOvershootPercentage(0);
    ...
    scrollWheelJetSpeed.setOvershootPercentage(0);
...
void BathtubScreenViewBase::updateItemCallbackHandler(touchgfx::DrawableListItemsInterface* items, int16_t containerIndex, int16_t itemIndex)
{
    ...
    if (items == &scrollWheelTemperatureSelectedListItems)
    {
        touchgfx::Drawable* d = items->getDrawable(containerIndex);
    ...
    if (items == &scrollWheelJetSpeedSelectedListItems)
    {
        touchgfx::Drawable* d = items->getDrawable(containerIndex);
        BathtubWheelElementCenter* cc = (BathtubWheelElementCenter*)d;
